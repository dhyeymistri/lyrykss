  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="mb-10">
        ...
        <div className="mt-5">
          {songData?.sections[1].type === 'LYRICS' ? songData?.sections[1].text.map((line) => (<p className="text-gray-400 text-base my-1">{line}</p>)) : <p className="text-gray-400 text-base my-1">Sorry, no Lyrics found!</p>}
        </div>
      </div>
